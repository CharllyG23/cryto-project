<template>
    <div class="cryptoTicker">
        ...
        <div class="cryptoTicker__cards">
           <div class="cryptoTicker__cards--content">
            <h1 class="pb-4">Volumen</h1>
                <div class="cryptoTicker__cards--header">
                    <svg width="28" height="28" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.2915 3.375H29.4582" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M2.5415 8.33329L8.20817 2.66663" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M8.20801 2.66663V26.75" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.2915 10.4583H26.6248" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.2915 17.5416H23.7915" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.2915 24.625H20.9582" stroke="#2C61E9" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span>R$ 90.057,25</span>
                </div>
           </div>
...
const setTiker = () => {
	nextTick(() => (props.ticker.value = true))
    console.log("ver si funciona", setTiker)
}
</script>
